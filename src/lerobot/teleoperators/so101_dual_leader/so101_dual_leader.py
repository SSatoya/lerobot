...
class SO101DualLeader(Teleoperator):
    ...
    def __init__(self, config: SO101DualLeaderConfig):
        """
        Initialize the SO-101 Dual Leader Arm
        SO-101 双腕リーダーアームを初期化
        """
    ...
    def action_features(self) -> dict[str, type]:
        """
        Returns the action features for the SO-101 Dual Leader Arm.
        アクション特徴を返す
        """
        features = {}
    ...
    def calibrate(self) -> None:
        """
        Run calibration for the SO-101 Dual Leader Arm.
        キャリブレーションを実行する
        """
    ...
    def configure(self)  -> None:
        """
        Configure the motors for the SO-101 Dual Leader Arm.
        SO-101 双腕リーダーアームのモーターを設定する
        """
    ...
    def get_action(self) -> dict[str, float]:
        """
        Read the current action from the SO-101 Dual Leader Arm.
        アクションを取得する
        """
