...
def make_robot_from_config(config: RobotConfig) -> Robot:
    ...
    elif config.type == "so101_6axis_follower":
        from .so101_6axis_follower import SO1016AxisFollower

        return SO1016AxisFollower(config)
    ...
    elif config.type == "bi_so101_6axis_follower":
        from .bi_so101_6axis_follower import BiSO1016AxisFollower

        return BiSO1016AxisFollower(config)
